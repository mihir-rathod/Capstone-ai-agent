...
Generate the complete report now."""
    ...
    response = client.generate('gpt-oss:120b', prompt)
    
    try:
        # The response from ollama client typically has a 'response' attribute containing the text
        ...
        raise ValueError(f"Ollama output not valid JSON: {e}")
